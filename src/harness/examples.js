...
module.exports = [
  {
    ...
    steps: [
      { id: 's1', title: '입력 정리', stepType: 'intake', detail: '녹취/메모에서 잡담·중복을 제거하고 주제별로 묶는다.' },
      { id: 's2', title: '핵심 추출', stepType: 'analyze', detail: '결정사항과 미결 안건을 구분해 추출한다.' },
      { id: 's3', title: '액션 아이템화', stepType: 'transform', detail: '각 항목에 담당자와 기한을 붙인다. 없으면 "미정"으로 표기.' },
      { id: 's4', title: '형식 출력', stepType: 'output', detail: '결정사항 / 액션 아이템(표) / 다음 안건 3단 구조로 출력.' }
    ],
    tools: [
